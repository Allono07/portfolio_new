...
export default function CinematicShell() {
  ...
  return <div className="cinematic-shell" style={{ '--font-scale': fontScale }}>
    ...
    <header className="site-header">
      ...
      <NavLink to="">Home</NavLink>  <NavLink to="/about">About</NavLink><NavLink to="/portfolio">Work</NavLink><Link to="/forum">Building</Link><NavLink to="/blog">Blogs</NavLink><NavLink to="/forum">Forum</NavLink><NavLink to="/contact" className="nav-contact">Let’s talk <span aria-hidden="true">↗</span></NavLink>
      </nav>
